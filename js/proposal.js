...
function collectFormData() {
    ...
    proposalData.discountValue = proposalData.servicesValue * (proposalData.discountPercentage / 100);
    proposalData.finalValue = proposalData.servicesValue - proposalData.discountValue;
            ...
            <div class="proposal-total">
                <div class="row">
                    ...
                    <div class="col-md-4 text-end">
                        <h4>R$ ${proposalData.servicesValue.toFixed(2)}</h4>
                    </div>
                </div>
